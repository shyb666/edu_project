<template>
    <el-container class="container">
      ...
      <el-header class="header-title">类型模糊查询</el-header>
      <el-main>
        <el-row :gutter="20">
...
import { getCoursesByTypeAPI } from "@/apis/user"
...
const getCourseByType = async() => {
  try {
    const res = await getCoursesByTypeAPI(courseType.value)
